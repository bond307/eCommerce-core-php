...
.panel-heading {
  ...
  <section class="main-container col1-layout">
    ...
    <div class="col-md-10 col-md-offset-1 order-success">
        <div class="col-md-6 col-md-offset-3">
            ...
            <h4>Thank you for your order: <span class="text-danger"><?= $_SESSION['name']?></span></h4>
        </div>
                    ...
                    <tr>
                       <td><img style="height:100px;" src="admin/images/product/fetcher-product/<?= $Order_Product['product_img']?>" alt=""></td>
                        ...
                        <h5><?= $Order_Product['product_name'];?></h5>
                          <?php 
                         if($Order_Product['product_size'] != ''){  ?>
                        <small><a >Size : <span class=""><?= $Order_Product['product_size']?></span></a></small> 
                        
                       <?php } if($Order_Product['product_color'] != '' ){
                             $get_color = explode(",",$Order_Product['product_color']);
  ...
  <div class="col-md-10 col-md-offset-1">
         <a href="shop.php" class="pull-left btn btn-secoundery"><i class="fa fa-arrow-left"></i> Got to shop page</a>
        <button onclick="printDiv()" class="pull-right btn btn-danger"><i class="fa fa-print"> </i>print</button>
